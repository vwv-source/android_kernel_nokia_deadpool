...
enum qpnp_adc_scale_fn_type {
	...
	SCALE_BATT_THERM_FIH_B3435_10K = 30,
	SCALE_BATT_THERM_FIH_B3435_10K_EAG, /* 31 */
	SCALE_BATT_THERM_FIH_B3435_10K_OD6, /* 32 */
	SCALE_BATT_THERM_FIH_B4250_100K_OD6, /* 33 */
	SCALE_NONE,
};
...
struct qpnp_vadc_result {
	...
	int64_t		measurement;
	int64_t		physical;
	int			fih_cur_lvl; // FIHTDC, IdaChiang, add for therm pin voltage 
};
