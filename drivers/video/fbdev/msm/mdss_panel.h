...
enum {	//this id syncs with the item 'fih,panel-id' of each panel's dtsi
	//SIMULATION_PANEL = 0,
	FIH_ST7703_TRULY_HD_PLUS_VIDEO_PANEL = 0,
	FIH_HX83102_HD_PLUS_VIDEO_PANEL = 1,
	FIH_HX83102_HD_PLUS_INNO_VIDEO_PANEL = 2,
	FIH_ST7703_CTC_HD_PLUS_VIDEO_PANEL = 3,
	FIH_NT36525_HD_PLUS_INNO_VIDEO_PANEL = 4,
	FIH_ST7703_INX_HD_PLUS_VIDEO_PANEL = 5,
	FIH_JD9365Z_CTC_HD_PLUS_VIDEO_PANEL = 6,
	FIH_FT8607_SHARP_720P_VIDEO_PANEL = 7,
	FIH_HX8352_TM_240x400_VIDEO_PANEL = 8,	//SW4-HL-Display-TC358762_HX8352-BringUp-00+_20181219
};
//SW4-HL-Display-ImplementPanelID-00+}_20151112
