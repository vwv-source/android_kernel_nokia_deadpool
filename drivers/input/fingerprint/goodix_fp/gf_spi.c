...
static irqreturn_t gf_irq(int irq, void *handle)
{
	...
	__pm_wakeup_event(ws, WAKELOCK_HOLD_TIME);
	sendnlmsg(&msg);
...
#endif
{
	...
	ws = wakeup_source_register("fp_wakelock");
...
static int __init gf_init(void)
{
	...
	if(((strstr(saved_command_line, "androidboot.fp=gxfp") == NULL)) || (strstr(saved_command_line,"androidboot.mode=charger") != NULL)) {
