...
/*****************************************************************************
*
* File Name: focaltech_upgrade_ft7311.c
*
...
*****************************************************************************/
static int fts_ft7311_init(void)
{
    ...
    upgrade_func_ft7311.fwveroff = upg->fw_length - 2;
    return 0;
}

/************************************************************************
* Name: fts_ft7311_upgrade
* Brief:
* Input:
* Output:
* Return: return 0 if success, otherwise return error code
***********************************************************************/
static int fts_ft7311_upgrade(struct i2c_client *client, u8 *buf, u32 len)
{
    int ret = 0;
    u32 start_addr = 0;
    u8 cmd[4] = { 0 };
    ...
    /* write app */
    start_addr = upgrade_func_ft7311.appoff;
...
struct upgrade_func upgrade_func_ft7311 = {
    .ctype = {0x02},
    .fwveroff = 0x0000,
    .fwcfgoff = 0xD780,
    .appoff = 0x0000,
    ...
    .hid_supported = true,
    .init = fts_ft7311_init,
    .upgrade = fts_ft7311_upgrade,
};
