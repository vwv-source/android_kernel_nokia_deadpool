...
*
* File Name: Focaltech_test_ft7311.c
*
...
struct stCfg_FT7311_BasicThreshold {
    u8 FW_VER_VALUE;
...
enum enumTestItem_FT7311 {
    Code_FT7311_ENTER_FACTORY_MODE,//All IC are required to test items
    Code_FT7311_DOWNLOAD,//All IC are required to test items
    Code_FT7311_UPGRADE,//All IC are required to test items
    Code_FT7311_FACTORY_ID_TEST,
    Code_FT7311_PROJECT_CODE_TEST,
    Code_FT7311_FW_VERSION_TEST,
    Code_FT7311_IC_VERSION_TEST,
    Code_FT7311_RAWDATA_TEST,
    Code_FT7311_ADCDETECT_TEST,
    Code_FT7311_SCAP_CB_TEST,
    Code_FT7311_SCAP_RAWDATA_TEST,
    Code_FT7311_CHANNEL_NUM_TEST,
    Code_FT7311_INT_PIN_TEST,
    Code_FT7311_RESET_PIN_TEST,
    Code_FT7311_NOISE_TEST,
    Code_FT7311_WEAK_SHORT_CIRCUIT_TEST,
    Code_FT7311_UNIFORMITY_TEST,
    Code_FT7311_CM_TEST,
    Code_FT7311_RAWDATA_MARGIN_TEST,
    Code_FT7311_WRITE_CONFIG,//All IC are required to test items
    Code_FT7311_PANELDIFFER_TEST,
    Code_FT7311_PANELDIFFER_UNIFORMITY_TEST,
    Code_FT7311_LCM_ID_TEST,
    Code_FT7311_JUDEG_NORMALIZE_TYPE,
    Code_FT7311_TE_TEST,
    Code_FT7311_SITO_RAWDATA_UNIFORMITY_TEST,
    Code_FT7311_PATTERN_TEST,
    Code_FT7311_GPIO_TEST,
    Code_FT7311_LCD_NOISE_TEST,
};
/*****************************************************************************
* Static variables
*****************************************************************************/
...
*****************************************************************************/
struct stCfg_FT7311_TestItem g_stCfg_FT7311_TestItem;
struct stCfg_FT7311_BasicThreshold g_stCfg_FT7311_BasicThreshold;
...
unsigned char FT7311_TestItem_EnterFactoryMode(void);
unsigned char FT7311_TestItem_RawDataTest(bool *bTestResult);
unsigned char FT7311_TestItem_SCapRawDataTest(bool *bTestResult);
unsigned char FT7311_TestItem_SCapCbTest(bool *bTestResult);
unsigned char FT7311_TestItem_PanelDifferTest(bool *bTestResult);
unsigned char FT7311_TestItem_WeakShortTest(bool *bTestResult);


/************************************************************************
* Name: start_test_ft7311
* Brief:  Test entry. Determine which test item to test
* Input: none
* Output: none
* Return: Test Result, PASS or FAIL
***********************************************************************/
bool start_test_ft7311(void)
{
    ...
    for (iItemCount = 0; iItemCount < test_data.test_num; iItemCount++) {
        ...
        ///////////////////////////////////////////////////////FT7311_ENTER_FACTORY_MODE
        if (Code_FT7311_ENTER_FACTORY_MODE == test_data.test_item[iItemCount].itemcode
           ) {

            ReCode = FT7311_TestItem_EnterFactoryMode();
        ...
        ///////////////////////////////////////////////////////FT7311_RAWDATA_TEST
        if (Code_FT7311_RAWDATA_TEST == test_data.test_item[iItemCount].itemcode
           ) {

            ReCode = FT7311_TestItem_RawDataTest(&bTempResult);
            if (ERROR_CODE_OK != ReCode || (!bTempResult)) {
                bTestResult = false;
                test_data.test_item[iItemCount].testresult = RESULT_NG;
            } else
        ...
        ///////////////////////////////////////////////////////FT7311_SCAP_CB_TEST
        if (Code_FT7311_SCAP_CB_TEST == test_data.test_item[iItemCount].itemcode
           ) {
            ReCode = FT7311_TestItem_SCapCbTest(&bTempResult);
            if (ERROR_CODE_OK != ReCode || (!bTempResult)) {
                bTestResult = false;
                test_data.test_item[iItemCount].testresult = RESULT_NG;
            } else
        ...
        ///////////////////////////////////////////////////////FT7311_SCAP_RAWDATA_TEST
        if (Code_FT7311_SCAP_RAWDATA_TEST == test_data.test_item[iItemCount].itemcode
           ) {
            ReCode = FT7311_TestItem_SCapRawDataTest(&bTempResult);
            if (ERROR_CODE_OK != ReCode || (!bTempResult)) {
                bTestResult = false;
                test_data.test_item[iItemCount].testresult = RESULT_NG;
            } else
        ...
        /////////////////////////////////////////////////////// Code_FT7311_PANELDIFFER_TEST,
        if (Code_FT7311_PANELDIFFER_TEST == test_data.test_item[iItemCount].itemcode
           ) {

            ReCode = FT7311_TestItem_PanelDifferTest(&bTempResult);
            if (ERROR_CODE_OK != ReCode || (!bTempResult)) {
                bTestResult = false;
                test_data.test_item[iItemCount].testresult = RESULT_NG;
            } else
        ...
        ///////////////////////////////////////////////////////Code_FT7311_WEAK_SHORT_CIRCUIT_TEST
        if (Code_FT7311_WEAK_SHORT_CIRCUIT_TEST == test_data.test_item[iItemCount].itemcode
           ) {

            ReCode = FT7311_TestItem_WeakShortTest(&bTempResult);
            if (ERROR_CODE_OK != ReCode || (!bTempResult)) {
                bTestResult = false;
                test_data.test_item[iItemCount].testresult = RESULT_NG;
            } else
...
/************************************************************************
* Name: FT7311_TestItem_EnterFactoryMode
...
/************************************************************************
* Name: FT7311_TestItem_RawDataTest
...
unsigned char FT7311_TestItem_RawDataTest(bool *bTestResult)
{
    ...
    if (test_data.screen_param.normalize == AUTO_NORMALIZE) {
        ...
        //Set Frequecy Low
        if (g_stCfg_FT7311_BasicThreshold.RawDataTest_SetLowFreq) {
            FTS_TEST_SAVE_INFO("\n\n=========Set Frequecy Low");
        ...
        //Set Frequecy High
        if ( g_stCfg_FT7311_BasicThreshold.RawDataTest_SetHighFreq ) {
...
/************************************************************************
* Name: FT7311_TestItem_SCapRawDataTest
...
unsigned char FT7311_TestItem_SCapRawDataTest(bool *bTestResult)
{
    ...
    if (g_stCfg_FT7311_BasicThreshold.SCapRawDataTest_SetWaterproof_ON && bFlag ) {
        ...
        iCount = 0;
        RawDataMin = g_stCfg_FT7311_BasicThreshold.SCapRawDataTest_ON_Min;
        RawDataMax = g_stCfg_FT7311_BasicThreshold.SCapRawDataTest_ON_Max;
    ...
    if (g_stCfg_FT7311_BasicThreshold.SCapRawDataTest_SetWaterproof_OFF && bFlag) {
        ...
        iCount = 0;
        RawDataMin = g_stCfg_FT7311_BasicThreshold.SCapRawDataTest_OFF_Min;
        RawDataMax = g_stCfg_FT7311_BasicThreshold.SCapRawDataTest_OFF_Max;
...
/************************************************************************
* Name: FT7311_TestItem_SCapCbTest
...
unsigned char FT7311_TestItem_SCapCbTest(bool *bTestResult)
{
    ...
    //Waterproof ON
    bFlag = GetTestCondition(WT_NeedProofOnTest, wc_value);
    if (g_stCfg_FT7311_BasicThreshold.SCapCbTest_SetWaterproof_ON && bFlag) {
    ...
    bFlag = GetTestCondition(WT_NeedProofOffTest, wc_value);
    if (g_stCfg_FT7311_BasicThreshold.SCapCbTest_SetWaterproof_OFF && bFlag) {
...
/************************************************************************
* Name: FT7311_TestItem_PanelDifferTest
...
/************************************************************************
* Name: FT7311_TestItem_WeakShortTest
...
unsigned char FT7311_TestItem_WeakShortTest( bool *bTestResult )
{
    ...
    iCCRsen = g_stCfg_FT7311_BasicThreshold.WeakShortTest_CC_Rsen;
    bCapShortTest = g_stCfg_FT7311_BasicThreshold.WeakShortTest_CapShortTest;
    FTS_TEST_SAVE_INFO("\n iCCRsen:%d.  \n", iCCRsen);
    FTS_TEST_SAVE_INFO("\n bCapShortTest:%d.  \n", bCapShortTest);
    ...
    /////////////////////////////////////////////Channel and Ground
    iMin_CG = g_stCfg_FT7311_BasicThreshold.WeakShortTest_CG;
    ...
    /////////////////////////////////////////////Channel and Channel
    iMin_CC = g_stCfg_FT7311_BasicThreshold.WeakShortTest_CC;
...
void init_testitem_ft7311(char *strIniFile)
{
    char str[512];
    FTS_TEST_FUNC_ENTER();
...
void set_testitem_sequence_ft7311(void)
{
    ...
    //////////////////////////////////////////////////FACTORY_ID_TEST
    if ( g_stCfg_FT7311_TestItem.FACTORY_ID_TEST == 1) {

        fts_set_testitem(Code_FT7311_FACTORY_ID_TEST);
    }

    //////////////////////////////////////////////////Project Code Test
    if ( g_stCfg_FT7311_TestItem.PROJECT_CODE_TEST == 1) {

        fts_set_testitem(Code_FT7311_PROJECT_CODE_TEST);
    }

    //////////////////////////////////////////////////FW Version Test
    if ( g_stCfg_FT7311_TestItem.FW_VERSION_TEST == 1) {

        fts_set_testitem(Code_FT7311_FW_VERSION_TEST);
    }

    //////////////////////////////////////////////////Enter Factory Mode
    fts_set_testitem(Code_FT7311_ENTER_FACTORY_MODE);

    //////////////////////////////////////////////////CHANNEL_NUM_TEST
    if ( g_stCfg_FT7311_TestItem.CHANNEL_NUM_TEST == 1) {

        fts_set_testitem(Code_FT7311_CHANNEL_NUM_TEST);
    }

    //////////////////////////////////////////////////LCD_NOISE_TEST
    if ( g_stCfg_FT7311_TestItem.LCD_NOISE_TEST == 1) {

        fts_set_testitem(Code_FT7311_LCD_NOISE_TEST);
    }

    //////////////////////////////////////////////////NOISE_TEST
    if ( g_stCfg_FT7311_TestItem.NOISE_TEST == 1) {

        fts_set_testitem(Code_FT7311_NOISE_TEST);
    }

    //////////////////////////////////////////////////RawData Test
    if ( g_stCfg_FT7311_TestItem.RAWDATA_TEST == 1) {

        fts_set_testitem(Code_FT7311_RAWDATA_TEST);
    }

    //////////////////////////////////////////////////Rawdata Uniformity Test
    if ( g_stCfg_FT7311_TestItem.UNIFORMITY_TEST == 1) {

        fts_set_testitem(Code_FT7311_UNIFORMITY_TEST);
    }

    //////////////////////////////////////////////////SITO Rawdata Uniformity Test
    if ( g_stCfg_FT7311_TestItem.SITO_RAWDATA_UNIFORMITY_TEST == 1) {

        fts_set_testitem(Code_FT7311_SITO_RAWDATA_UNIFORMITY_TEST);
    }

    //////////////////////////////////////////////////SCAP_CB_TEST
    if ( g_stCfg_FT7311_TestItem.SCAP_CB_TEST == 1) {

        fts_set_testitem(Code_FT7311_SCAP_CB_TEST);
    }

    //////////////////////////////////////////////////SCAP_RAWDATA_TEST
    if ( g_stCfg_FT7311_TestItem.SCAP_RAWDATA_TEST == 1) {

        fts_set_testitem(Code_FT7311_SCAP_RAWDATA_TEST);
    }

    //////////////////////////////////////////////////WEAK_SHORT_CIRCUIT_TEST
    if ( g_stCfg_FT7311_TestItem.WEAK_SHORT_CIRCUIT_TEST == 1) {

        fts_set_testitem(Code_FT7311_WEAK_SHORT_CIRCUIT_TEST);
    }

    //////////////////////////////////////////////////panel differ_TEST
    if ( g_stCfg_FT7311_TestItem.PANEL_DIFFER_TEST == 1) {

        fts_set_testitem(Code_FT7311_PANELDIFFER_TEST);
    }

    FTS_TEST_FUNC_EXIT();
}

struct test_funcs test_func_ft7311 = {
    .ic_series = TEST_ICSERIES(IC_FT7311),
    .init_testitem = init_testitem_ft7311,
    .init_basicthreshold = init_basicthreshold_ft7311,
    .init_detailthreshold = init_detailthreshold_ft7311,
    .set_testitem_sequence  = set_testitem_sequence_ft7311,
    .start_test = start_test_ft7311,
};
