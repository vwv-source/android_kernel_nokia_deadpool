...
extern void touch_selftest_focalTP(void);
extern int selftest_result_read_focalTP(void);
extern void touch_tpfwver_read_focalTP(char *);
extern void touch_tpfwimver_read_focalTP(char *fw_ver);
extern void touch_fwupgrade_focalTP(int);
extern void touch_fwupgrade_read_focalTP(char *);
extern void touch_vendor_read_focalTP(char *);
...
static int fts_parse_dt(struct device *dev, struct fts_ts_platform_data *pdata)
{
    ...
    else
    {
      ...
      fw_app_bin = "TP_Firmware_FT7311.bin";
      tp_ini="7311.ini";
    }
    FTS_FUNC_EXIT();
    return 0;
...
static int fts_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    touch_cb.touch_selftest = touch_selftest_focalTP;
    touch_cb.touch_selftest_result = selftest_result_read_focalTP;
    touch_cb.touch_tpfwver_read = touch_tpfwver_read_focalTP;
    touch_cb.touch_tpfwimver_read = touch_tpfwimver_read_focalTP;
    touch_cb.touch_fwupgrade = touch_fwupgrade_focalTP;
    touch_cb.touch_fwupgrade_read = touch_fwupgrade_read_focalTP;
    touch_cb.touch_vendor_read = touch_vendor_read_focalTP;
