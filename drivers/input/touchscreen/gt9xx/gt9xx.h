...
#define GTP_RST_PORT    66 /* EXYNOS4_GPX2(0) */
#define GTP_INT_PORT    67 /* EXYNOS4_GPX2(1) */
...
/**************************PART3:OTHER define*******************************/
#define GTP_DRIVER_VERSION  "V2.8.0.3<2018/08/08>"
...
extern s32 fih_gtp_read_version(struct i2c_client *client, u16* version);
