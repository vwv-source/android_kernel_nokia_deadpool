...
struct himax_core_fp {
...
#ifdef CORE_FW
	void (*fp_parse_raw_data)(struct himax_report_data *hx_incell_touch_data, int mul_num, int self_num, uint8_t diag_cmd, int16_t *mutual_data, int16_t *self_data);
	...
	bool (*fp_diag_check_sum)(struct himax_report_data *hx_incell_touch_data);
	void (*fp_diag_parse_raw_data)(struct himax_report_data *hx_incell_touch_data, int mul_num, int self_num, uint8_t diag_cmd, int32_t *mutual_data, int32_t *self_data);
