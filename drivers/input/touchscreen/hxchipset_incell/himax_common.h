...
#define HIMAX_DRIVER_VER "1.2.2.37_ABCD1234_02"
...
#define HX_FIX_TOUCH_INFO	/* if open, you need to change the touch info in the fix_touch_info*/	//SW4-HL-Touch-FixSelfTestFail-RHD-1350-00*_20180906
...
enum fix_touch_info {
	FIX_HX_RX_NUM = 32,	//SW4-HL-Touch-FixSelfTestFail-RHD-1350-00*_20180906
	FIX_HX_TX_NUM = 18,	//SW4-HL-Touch-FixSelfTestFail-RHD-1350-00*_20180906
	FIX_HX_BT_NUM = 0,
	FIX_HX_X_RES = 720,	//SW4-HL-Touch-FixSelfTestFail-RHD-1350-00*_20180906
	FIX_HX_Y_RES = 1440,	//SW4-HL-Touch-FixSelfTestFail-RHD-1350-00*_20180906
	FIX_HX_MAX_PT = 10,	//SW4-HL-Touch-FixSelfTestFail-RHD-1350-00*_20180906
...
struct himax_debug {
	...
	int (*fp_set_diag_cmd)(struct himax_ic_data *ic_data, struct himax_report_data *hx_incell_touch_data);
};
...
extern int himax_incell_chip_common_suspend(struct himax_ts_data *ts);
extern int himax_chip_incell_common_resume(struct himax_ts_data *ts);
