...
/* INSOECTION Setting */
int HX_CRITERIA_ITEM_INCELL;
int HX_CRITERIA_SIZE_INCELL;
int HX_CRITERIA_OUTPUT_INDEX;
...
/* for criteria */
int **g_inspection_criteria_incell;
char *g_hx_inspt_crtra_name_incell[] = {
	"CRITERIA_RAW_MIN",
	"CRITERIA_RAW_MAX",
	"CRITERIA_SHORT_MIN",
	"CRITERIA_SHORT_MAX",
