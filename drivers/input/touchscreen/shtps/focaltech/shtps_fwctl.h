...
typedef int (*fwctl_if_get_chip_id_t)(struct shtps_fwctl_info *, u16 *);
...
struct shtps_fwctl_functbl{
	...
	fwctl_if_get_chip_id_t							get_chip_id_f;
};
/* --------------------------------------------------------------------------- */
...
#define shtps_fwctl_get_chip_id(ts, buf)												ts->fwctl_p->fwctl_func_p->get_chip_id_f(ts->fwctl_p, buf)
/* --------------------------------------------------------------------------- */
