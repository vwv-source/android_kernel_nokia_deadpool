...
#define HIMAX_PROC_SMWP_FILE_EAG "SMWP"
struct proc_dir_entry *himax_proc_SMWP_file_eag = NULL;
#define HIMAX_PROC_GESTURE_FILE_EAG "GESTURE"
struct proc_dir_entry *himax_proc_GESTURE_file_eag = NULL;
uint8_t HX_SMWP_EN_eag = 0;
//extern bool FAKE_POWER_KEY_SEND_EAG;
#endif
...
#define HIMAX_PROC_FW_UPGRADE_FILE	"fw_upgrade"
struct proc_dir_entry *himax_proc_fw_upgrade_file = NULL;
#endif
