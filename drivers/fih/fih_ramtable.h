...
#define FIH_RAM_SIZE					0x00A00000
#define FIH_RAM_SIZE_MB					10

#define FIH_MEM_PSTORE_SIZE FIH_LAST_ALOG_MAIN_BASE
#define FIH_MEM_PSTORE_ADDR (FIH_LAST_KMSG_BASE - FIH_LAST_ALOG_MAIN_BASE)
 /* -------------------------------------------------------- */
/* modem rf_nv */
...
/* -------------------------------------------------------- 8MB */
/* last_alog_main */
#define FIH_LAST_ALOG_MAIN_BASE			(FIH_MODEM_DEFAULT_NV_BASE + FIH_MODEM_DEFAULT_NV_SIZE)
...
/* rsu token */
#define FIH_RSUTOKEN_BASE				(FIH_LCMDATA_BASE + FIH_LCMDATA_SIZE)
#define FIH_RSUTOKEN_SIZE				0x00001000
#define FIH_RSUTOKEN_MEM_ADDR			FIH_RSUTOKEN_BASE
#define FIH_RSUTOKEN_MEM_SIZE			FIH_RSUTOKEN_SIZE

/* no use 6 */
#define FIH_NO_USE_6_BASE				(FIH_RSUTOKEN_BASE + FIH_RSUTOKEN_SIZE)
 ...
 * 0xC360_0000 | 0x0040_0000 | modem default_nv (4MB)
 * -------------------------------------------------------- 8MB
 * 0xC3A0_0000 | 0x0004_0000 | last_alog_main (256KB)
 * 0xC3A4_0000 | 0x0004_0000 | last_alog_events (256KB)
 * 0xC3A8_0000 | 0x0004_0000 | last_alog_radio (256KB)
 * 0xC3AC_0000 | 0x0004_0000 | last_alog_system (256KB)
 * 0xC3B0_0000 | 0x0004_0000 | last_kmsg (256KB)
 * 0xC3B4_0000 | 0x0002_0000 | last_blog (128KB)
 * 0xC3B6_0000 | 0x0002_0000 | blog (128KB)
 * -------------------------------------------------------- 9.5MB
 * 0xC3B8_0000 | 0x0000_0040 | hwid:hwcfg (64B)
 * 0xC3B8_0040 | 0x0000_0040 | secboot:devinfo (64B)
 * 0xC3B8_0080 | 0x0000_0100 | secboot:unlock (256B)
 * 0xC3B8_0180 | 0x0000_0080 | sutinfo (128B)
 * 0xC3B8_0200 | 0x0000_0010 | no use (16B)
 * 0xC3B8_0210 | 0x0000_0010 | bset (16B)
 * 0xC3B8_0220 | 0x0000_0010 | bat-id adc (16B)
 * 0xC3B8_0230 | 0x0000_0010 | no use (16B)
 * 0xC3B8_0240 | 0x0000_0020 | apr (32B)
 * 0xC3B8_0260 | 0x0000_0180 | no use (384B)
 * 0xC3B8_03E0 | 0x0000_0020 | mem (32B)
 * 0xC3B8_0400 | 0x0000_0C00 | no use (3KB)
 * 0xC3B8_1000 | 0x0000_1000 | e2p (4KB)
 * 0xC3B8_2000 | 0x0000_1000 | cda (4KB)
 * 0xC3B8_3000 | 0x0000_1000 | note (4KB)
 * 0xC3B8_4000 | 0x0000_1000 | hwcfg (4KB)
 * 0xC3B8_5000 | 0x0000_1000 | fac (4KB)
 * 0xC3B8_6000 | 0x0000_2000 | no use 5 (8KB)
 * 0xC3B8_8000 | 0x0004_0000 | fver (256KB)
 * 0xC3BC_8000 | 0x0000_C000 | sensordata (48KB)
 * 0xC3BD_4000 | 0x0000_4000 | lcmdata (16KB)
 * 0xC3BD_8000 | 0x0000_1000 | rsu token (4KB)
 * 0xC3BD_9000 | 0x0002_7000 | no use 6 (156KB)
 * -------------------------------------------------------- 10MB
 * 0xC3C0_0000 | 0x00A0_0000 | HLOS (10MB)
