...
static int fih_cpu_read_show(struct seq_file *m, void *v)
{
	...
	switch (device) {
		case HW_REV_NUM_SDM439: strcpy(msg, "SDM439, "); break;
		case HW_REV_NUM_SDM429: strcpy(msg, "SDM429, "); break;
		default: strcpy(msg, "Unknown"); break;
	}

	switch (sample_type) {
		case HW_REV_ES: strcat(msg, "ES, "); break;
		case HW_REV_CS: strcat(msg, "CS, "); break;
		default: strcpy(msg, "Unknown"); break;
	}
	sprintf(buf, "0x%X", featureid);
	strcat(msg, buf);
