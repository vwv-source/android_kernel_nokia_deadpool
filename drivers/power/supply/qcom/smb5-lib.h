...
#define DCP_2A_CURRENT_UA			2000000 // FIHTDC, IdaChiang, 2A DCP
...
struct smb_charger {
	...
	struct qpnp_vadc_chip	*vadc_usb_dev;
	...
	struct delayed_work 	update_batt_info_work; // FIHTDC, IdaChiang
	struct delayed_work     role_reversal_check;
	struct delayed_work     set_recharging_setting_work; // FIHTDC, IdaChiang
	...
	int			auto_recharge_vbat_mv; // FIHTDC, IdaChiang, add for warm temp recharging
